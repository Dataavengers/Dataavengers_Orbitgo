                ...
                <div class=" w-1/2 mt-8 border border-gray-500 rounded-lg shadow">
                    ...
                    <div class="flex flex-col items-center pb-10 ">
                        ...
                        <div class="flex flex-col p-10 m-1">
                            ...
                            <a href="#" className="inline-flex px-20 py-3 m-3  text-base font-medium text-lef text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700  ">Update your name </a>
